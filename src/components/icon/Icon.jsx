...
export const RadioIcon = ({ size, className }) => {
    return (
        <Icon size={size} className={className}>
            <path d="M12 24C5.37258 24 0 18.6274 0 12C0 5.37258 5.37258 0 12 0C18.6274 0 24 5.37258 24 12C24 18.6274 18.6274 24 12 24ZM12 16.8C14.6509 16.8 16.8 14.6509 16.8 12C16.8 9.34903 14.6509 7.2 12 7.2C9.34903 7.2 7.2 9.34903 7.2 12C7.2 14.6509 9.34903 16.8 12 16.8Z" fill="#003D88"/>
        </Icon>
    )
};